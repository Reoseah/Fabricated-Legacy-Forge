        ...
        if (!par2EntityPlayer.method_3204(par4, par5, par6)) {
            ...
            if (MinecraftForge.EVENT_BUS.post(event)) {
                ...
                if ((par7 == 0 || var12 != 0 || var11 != Block.GRASS_BLOCK.id) && var11 != Block.DIRT.id) {
                    ...
                    par3World.playSound((double)((float)par4 + 0.5F), (double)((float)par5 + 0.5F), (double)((float)par6 + 0.5F), var13.soundGroup.getStepSound(), (var13.soundGroup.getVolume() + 1.0F) / 2.0F, var13.soundGroup.getPitch() * 0.8F);
